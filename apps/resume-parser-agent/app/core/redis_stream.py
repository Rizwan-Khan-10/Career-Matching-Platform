...
def consume_loop(stream: str, group: str, consumer_name: str, handler):
    """
    handler(data: dict) -> None
    Runs forever, blocking-reads new messages, acks after successful handling.
    """
                ...
                for _, messages in resp:
                    for msg_id, fields in messages:
                        ...
                        try:
                            ...
                            # left un-acked — will be redelivered; add dead-letter handling later
        except Exception as e:
